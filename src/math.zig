...
pub usingnamespace @import("math/generic_vector.zig");
pub usingnamespace @import("math/mat4.zig");
pub usingnamespace @import("math/quaternion.zig");
...
pub fn toRadians(degrees: anytype) @TypeOf(degrees) {
    ...
    return switch (@typeInfo(T)) {
        ...
        .ComptimeFloat => degrees * (math.pi / 180.0),
...
pub fn toDegrees(radians: anytype) @TypeOf(radians) {
    ...
    return switch (@typeInfo(T)) {
        ...
        .ComptimeFloat => radians * (180.0 / math.pi),
