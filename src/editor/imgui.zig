...
pub const BackendFlags = packed struct {
    ...
    RendererHasViewport: bool = false,
    __reserved_bit_13: bool = false,
    __reserved_bit_14: bool = false,
    __reserved_bit_15: bool = false,
    __reserved_bit_16: bool = false,
...
pub const KeyModFlagsInt = FlagsInt;
pub const KeyModFlags = packed struct {
    Ctrl: bool = false,
    Shift: bool = false,
    Alt: bool = false,
    Super: bool = false,
...
pub const NavInput = enum(i32) {
    ...
    pub const Self = @This();
    pub const InternalStart_ = Self.KeyLeft_;
};
...
pub const IO = extern struct {
    ...
    ConfigDrawClickToInputText: bool,
    ...
    KeyMods: KeyModFlags,
    KeyModsPrev: KeyModFlags,
    MousePosPrev: Vec2,
    MouseClickedPos: [5]Vec2,
    MouseClickedTime: [5]f64,
    MouseClicked: [5]bool,
    MouseDoubleClicked: [5]bool,
    MouseClickedCount: [5]bool,
    MouseClickedLastCount: [5]bool,
...
pub const ListClipper = extern struct {
    ...
    pub const BeginExt_ = raw.ImGuiListClipper_Begin;
    pub inline fn Begin(self: *ListClipper, items_count: i32) void {
        return BeginExt_(self, items_count, -1.0);
    }
...
pub inline fn ComboFnPtr(label: ?[*:0]const u8, current_item: ?*i32, items_getter: ?fn (data: ?*anyopaque, idx: i32, out_text: *?[*:0]const u8) callconv(.C) bool, data: ?*anyopaque, items_count: i32) bool {
...
pub inline fn ListBoxFnPtr(label: ?[*:0]const u8, current_item: ?*i32, items_getter: ?fn (data: ?*anyopaque, idx: i32, out_text: *?[*:0]const u8) callconv(.C) bool, data: ?*anyopaque, items_count: i32) bool {
...
pub inline fn PlotHistogramFnPtr(label: ?[*:0]const u8, values_getter: ?fn (data: ?*anyopaque, idx: i32) callconv(.C) f32, data: ?*anyopaque, values_count: i32) void {
...
pub inline fn PlotLinesFnPtr(label: ?[*:0]const u8, values_getter: ?fn (data: ?*anyopaque, idx: i32) callconv(.C) f32, data: ?*anyopaque, values_count: i32) void {
...
pub inline fn SetAllocatorFunctions(alloc_func: ?fn (sz: usize, user_data: ?*anyopaque) callconv(.C) ?*anyopaque, free_func: ?fn (ptr: ?*anyopaque, user_data: ?*anyopaque) callconv(.C) void) void {
...
pub const raw = struct {
    ...
    pub extern fn ImGuiStoragePair_ImGuiStoragePairPtr(self: *StoragePair, _key: ID, _val_p: ?*anyopaque) callconv(.C) void;
    ...
    pub extern fn igComboFnPtr(label: ?[*:0]const u8, current_item: ?*i32, items_getter: ?fn (data: ?*anyopaque, idx: i32, out_text: *?[*:0]const u8) callconv(.C) bool, data: ?*anyopaque, items_count: i32, popup_max_height_in_items: i32) callconv(.C) bool;
    ...
    pub extern fn igListBoxFnPtr(label: ?[*:0]const u8, current_item: ?*i32, items_getter: ?fn (data: ?*anyopaque, idx: i32, out_text: *?[*:0]const u8) callconv(.C) bool, data: ?*anyopaque, items_count: i32, height_in_items: i32) callconv(.C) bool;
    ...
    pub extern fn igPlotHistogramFnPtr(label: ?[*:0]const u8, values_getter: ?fn (data: ?*anyopaque, idx: i32) callconv(.C) f32, data: ?*anyopaque, values_count: i32, values_offset: i32, overlay_text: ?[*:0]const u8, scale_min: f32, scale_max: f32, graph_size: Vec2) callconv(.C) void;
    ...
    pub extern fn igPlotLinesFnPtr(label: ?[*:0]const u8, values_getter: ?fn (data: ?*anyopaque, idx: i32) callconv(.C) f32, data: ?*anyopaque, values_count: i32, values_offset: i32, overlay_text: ?[*:0]const u8, scale_min: f32, scale_max: f32, graph_size: Vec2) callconv(.C) void;
    ...
    pub extern fn igSetAllocatorFunctions(alloc_func: ?fn (sz: usize, user_data: ?*anyopaque) callconv(.C) ?*anyopaque, free_func: ?fn (ptr: ?*anyopaque, user_data: ?*anyopaque) callconv(.C) void, user_data: ?*anyopaque) callconv(.C) void;
    ...
    pub extern fn igSliderScalar(label: ?[*:0]const u8, data_type: DataType, p_data: ?*anyopaque, p_min: ?*const anyopaque, p_max: ?*const anyopaque, format: ?[*:0]const u8, power: f32) callconv(.C) bool;
    pub extern fn igSliderScalarN(label: ?[*:0]const u8, data_type: DataType, p_data: ?*anyopaque, components: i32, p_min: ?*const anyopaque, p_max: ?*const anyopaque, format: ?[*:0]const u8, power: f32) callconv(.C) bool;
    ...
    pub extern fn igVSliderScalar(label: ?[*:0]const u8, size: Vec2, data_type: DataType, p_data: ?*anyopaque, p_min: ?*const anyopaque, p_max: ?*const anyopaque, format: ?[*:0]const u8, power: f32) callconv(.C) bool;
